...
\begin{itemize}
      \item \textbf{Finding a more compact representation of FTML.}\\
      ...
      \item \textbf{User course selection to improve retrieval accuracy.}\\
      ...
      \item \textbf{Application to other courses.}\\
      ...
      \item \textbf{Application to image-oriented courses.}\\
      ...
      \item \textbf{Incorporating prerequisite relevance indicators for retrieved content.}\\
      ...
      \item \textbf{Validity of LLM-as-a-judge in educational contexts.}\\
      ...
      \item \textbf{Experimentation with larger and more sophisticated models.}\\

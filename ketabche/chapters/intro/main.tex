...
\end{itemize}
\input{chapters/intro/sections/Resulting Issues.tex}
\input{chapters/intro/sections/Research Questions.tex}

\input{chapters/intro/sections/Contribution.tex}
\section{Overview}

The remainder of this thesis is organized as follows.

\textbf{Chapter~\ref{chap:fundamentals}} provides the necessary background on the foundational technologies employed in this work, including large language models, retrieval-augmented generation, fine-tuning techniques, and the RAFT paradigm. It also reviews related platforms such as MathHub and ALeA, and surveys the current state of the art in personalized educational AI systems.

\textbf{Chapter~\ref{chap:methods}} describes the proposed Tripartite RAFT approach in detail. It presents the datasets constructed for this thesis, the baseline methods established for comparison, the design of the RAG pipeline---including hybrid search, prerequisite gathering, and prompt construction---and the fine-tuning procedure used to adapt the language model to the educational domain.

\textbf{Chapter~\ref{chap:evaluation}} evaluates the proposed system through multiple lenses. It presents illustrative baseline examples, employs an LLM-as-a-judge framework to assess contextual relevancy, answer relevancy, and faithfulness, reports human expert evaluations, and discusses experiments with different embedding models.

\textbf{Chapter~\ref{chap:conclusion}} summarizes the contributions of this thesis, revisits the research questions in light of the experimental findings, discusses the limitations encountered during this work, and outlines directions for future research.

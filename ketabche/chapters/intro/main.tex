...
Throughout history, as technology has evolved, so to have methods of learning.
...
we now examine these limitations in detail.
\begin{itemize}
...
\begin{enumerate}
    \item We design and implement a Retrieval-Augmented Generation (RAG) pipeline tailored for educational applications.
    \item We experiment with various embedding models and analyze the impact of embedding dimensions on retrieval quality.
    \item We fine-tune a language model for answering student questions in a domain-specific context.
    \item We propose TriprtieRAG\footnote{pri}, a novel approach that combines the above techniques.
\end{enumerate}

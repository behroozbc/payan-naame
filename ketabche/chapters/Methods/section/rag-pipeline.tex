...
The results of two search methods are FTML content which has a lot of unuseful HTML tags which cause LLMs context become full, so we remove many of them to make the html more rubust and fits context size of small models.

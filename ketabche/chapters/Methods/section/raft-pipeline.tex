...
The model was fine-tuned for one epoch and 20 steps on the fine-tuning dataset (Section~\ref{fine_tune_dataset}). If training continue after the 20 the model become overfit to the data and last a variety of the answer.
